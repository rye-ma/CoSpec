...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="./beijing/configs/next_location_prediction.yml",
        help="Path to next-location prediction config file",
    )
    parser.add_argument(
        "--pretrain_config",
        type=str,
